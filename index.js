...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:LORDESCREAMO\n' // GANTI NAMA LU
            + 'ORG:OWNER BOTZ;\n'
            + 'TEL;type=CELL;type=VOICE;waid=85987346914:+55 85 98734 6914\n' // GANTI NOMOR LU
            + 'END:VCARD'
		...
		case 'textlight':
		    ...
		    break
		        ...
		        case 'dono':
					...
					buffer = await getBuffer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKBdlXnb-xR_lcdBax-EwtI7AkFR-QpcPTdA&usqp=CAU`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*NOME:* ALUCARD\n*WPP:* wa.me+/55 85 987346914\n*INSTA:* aluc4rd_edits'})
					break					
                   case 'stalkig':
                   if (isBanned) return reply(nad.baned())
                   if (!isRegistered) return reply(nad.noregis())
...
*/
                ...
                addKoinUser('+55 85 987346914@s.whatsapp.net', fee)
